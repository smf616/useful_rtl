...
`define IP_UUID _96283b2d7952417ca14e9f10df845108
...
generate if (USE_LUTS==1) begin:USE_LUT_RAM 

(* syn_ramstyle = "registers" *) reg [MEM_DATA_WIDTH-1:0] ram[MEM_DEPTH-1:0];
