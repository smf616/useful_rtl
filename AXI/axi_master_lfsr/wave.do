...
add wave -noupdate /tb_memory_tester/axi_master_checker_U/arlock
add wave -noupdate /tb_memory_tester/axi_master_checker_U/arcache
add wave -noupdate /tb_memory_tester/axi_master_checker_U/arprot
add wave -noupdate /tb_memory_tester/axi_master_checker_U/arqos
add wave -noupdate /tb_memory_tester/axi_master_checker_U/arregion
...
add wave -noupdate /tb_memory_tester/axi_master_checker_U/awvalid_pre
...
add wave -noupdate /tb_memory_tester/axi_master_checker_U/bready_pre
add wave -noupdate /tb_memory_tester/axi_master_checker_U/wvalid_nxt
add wave -noupdate /tb_memory_tester/axi_master_checker_U/wvalid_pre
...
add wave -noupdate /tb_memory_tester/axi_master_checker_U/rready_pre
add wave -noupdate /tb_memory_tester/axi_master_checker_U/arvalid_nxt
add wave -noupdate /tb_memory_tester/axi_master_checker_U/arvalid_pre
...
add wave -noupdate /tb_memory_tester/axi_master_checker_U/wlast_nxt
add wave -noupdate /tb_memory_tester/axi_master_checker_U/lfsr_seed
add wave -noupdate /tb_memory_tester/axi_master_checker_U/lfsr_r
...
add wave -noupdate /tb_memory_tester/axi_master_checker_U/lfsr_r_nxt
add wave -noupdate /tb_memory_tester/axi_master_checker_U/lfsr_feedback
add wave -noupdate /tb_memory_tester/axi_master_checker_U/wr_finish
add wave -noupdate /tb_memory_tester/axi_master_checker_U/rd_finish
add wave -noupdate /tb_memory_tester/axi_master_checker_U/lfsr_seed
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {12546483 ps} 0}
...
update
WaveRestoreZoom {12494132 ps} {12591663 ps}
